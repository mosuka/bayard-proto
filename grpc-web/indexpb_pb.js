...
goog.exportSymbol('proto.bayard.index.MetricsReply', null, global);
goog.exportSymbol('proto.bayard.index.MetricsReq', null, global);
 ...
 * @constructor
 */
proto.bayard.index.MetricsReq = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bayard.index.MetricsReq, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bayard.index.MetricsReq.displayName = 'proto.bayard.index.MetricsReq';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @constructor
 */
proto.bayard.index.MetricsReply = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.bayard.index.MetricsReply, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.bayard.index.MetricsReply.displayName = 'proto.bayard.index.MetricsReply';
}
/**
 * Generated by JsPbCodeGenerator.
 * @param {Array=} opt_data Optional initial data array, typically from a
 ...
 * @return {!Object}
 */
proto.bayard.index.MetricsReq.prototype.toObject = function(opt_includeInstance) {
  return proto.bayard.index.MetricsReq.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bayard.index.MetricsReq} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bayard.index.MetricsReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    clientId: jspb.Message.getFieldWithDefault(msg, 1, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bayard.index.MetricsReq}
 */
proto.bayard.index.MetricsReq.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bayard.index.MetricsReq;
  return proto.bayard.index.MetricsReq.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bayard.index.MetricsReq} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bayard.index.MetricsReq}
 */
proto.bayard.index.MetricsReq.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bayard.index.MetricsReq.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bayard.index.MetricsReq.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bayard.index.MetricsReq} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bayard.index.MetricsReq.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getClientId();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @return {number}
 */
proto.bayard.index.MetricsReq.prototype.getClientId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.bayard.index.MetricsReq.prototype.setClientId = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
 ...
 * @return {!Object}
 */
proto.bayard.index.MetricsReply.prototype.toObject = function(opt_includeInstance) {
  return proto.bayard.index.MetricsReply.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.bayard.index.MetricsReply} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bayard.index.MetricsReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    state: jspb.Message.getFieldWithDefault(msg, 1, 0),
    metrics: jspb.Message.getFieldWithDefault(msg, 2, ""),
    addressMap: msg.getAddressMap_asB64(),
    leaderId: jspb.Message.getFieldWithDefault(msg, 4, 0)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.bayard.index.MetricsReply}
 */
proto.bayard.index.MetricsReply.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.bayard.index.MetricsReply;
  return proto.bayard.index.MetricsReply.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.bayard.index.MetricsReply} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.bayard.index.MetricsReply}
 */
proto.bayard.index.MetricsReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.bayard.index.MetricsReply.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.bayard.index.MetricsReply.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.bayard.index.MetricsReply} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.bayard.index.MetricsReply.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getState();
  if (f !== 0.0) {
    writer.writeEnum(
 ...
 * @return {!proto.bayard.common.State}
 */
proto.bayard.index.MetricsReply.prototype.getState = function() {
  return /** @type {!proto.bayard.common.State} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.bayard.common.State} value */
proto.bayard.index.MetricsReply.prototype.setState = function(value) {
  jspb.Message.setProto3EnumField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.bayard.index.MetricsReply.prototype.getMetrics = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.bayard.index.MetricsReply.prototype.setMetrics = function(value) {
  jspb.Message.setProto3StringField(this, 2, value);
};
 ...
 * @return {string}
 */
proto.bayard.index.MetricsReply.prototype.getAddressMap = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 3, ""));
};
 ...
 * @return {string}
 */
proto.bayard.index.MetricsReply.prototype.getAddressMap_asB64 = function() {
  return /** @type {string} */ (jspb.Message.bytesAsB64(
      this.getAddressMap()));
};
 ...
 * @return {!Uint8Array}
 */
proto.bayard.index.MetricsReply.prototype.getAddressMap_asU8 = function() {
  return /** @type {!Uint8Array} */ (jspb.Message.bytesAsU8(
      this.getAddressMap()));
};
...
/** @param {!(string|Uint8Array)} value */
proto.bayard.index.MetricsReply.prototype.setAddressMap = function(value) {
  jspb.Message.setProto3BytesField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.bayard.index.MetricsReply.prototype.getLeaderId = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {number} value */
proto.bayard.index.MetricsReply.prototype.setLeaderId = function(value) {
  jspb.Message.setProto3IntField(this, 4, value);
};
