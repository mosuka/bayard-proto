...
proto.bayard.index.SearchReq.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    excludeCount: jspb.Message.getFieldWithDefault(msg, 4, false),
    excludeDocs: jspb.Message.getFieldWithDefault(msg, 5, false),
    facetField: jspb.Message.getFieldWithDefault(msg, 6, ""),
    facetPrefixesList: jspb.Message.getRepeatedField(msg, 7),
